  ...
  <div class="site-wrap">
    ...
    <div class="unit-5 overlay" style="background-image: url(<?php echo base_url('assets/user2/images/hero_bg_2.jpg')?>);">
      <div class="container text-center">
        <h2 class="mb-0">Daftar Lembaga Pelatihan</h2>
    ...
    <div class="site-section bg-light">
      <div class="container">
      <h2><strong><center>- Daftar Lembaga Pelatihan -</center></strong></h2><br>
           ...
           <div class="job-post-item bg-white p-4 d-block d-md-flex align-items-center">
              <div class="mb-4 mb-md-0 mr-5">
               <div class="job-post-item-header d-flex align-items-center">
                 <h2 class="mr-3 text-black h4">Dinas Komunikasi dan Informatika Kota Malang</h2>
               ...
               <div class="job-post-item-body d-block d-md-flex">
                 ...
                 <div><span class="fl-bigmug-line-big104"></span> <span>Kota Malang</span></div>
               </div>
              </div>
              <div class="ml-auto">
                <img src="<?=base_url()?>/assets/user2/images/star.png"> 4.7 / 5 &nbsp;
                <a href="<?=base_url()?>/user/profil_lembaga" class="btn btn-primary py-2">Lihat</a>
              </div>
           </div>
         </div>
        </div>
