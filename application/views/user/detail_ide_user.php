  ...
  <div class="site-wrap">
    ...
    <div class="unit-5 overlay" style="background-image: url(<?php echo base_url('assets/user2/images/hero_bg_2.jpg')?>);">
      <div class="container text-center">
        <h2 class="mb-0">Ternak Lele</h2>
        <p class="mb-0 unit-6"><a href="<?=base_url()?>/user/index">Beranda</a> <span class="sep">></span> <span>Ternak Lele</span></p>
      </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="p-5 bg-white">
              ...
              <div class="mb-4 mb-md-5 mr-5">
               <div class="job-post-item-header d-flex align-items-center">
                 <h2 class="mr-3 text-black h4">Ternak Lele</h2>
                 <div class="badge-wrap">
                  <span class="bg-danger text-white badge py-2 px-4">Peternakan</span>
                 </div>
               </div>
               <div class="job-post-item-body d-block d-md-flex">
                 ...
                 <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="icon-heart"></span> &nbsp;3</div>
               </div>
              </div>
          ...
          <!-- DESKRIPSI -->
              ...
              <div class="ml-auto">
                ...
                <a href="<?=base_url()?>/user/ubah_ide" class="btn btn-primary py-2">Ubah</a>
              </div>
            </div>
          </div>
        </div>
