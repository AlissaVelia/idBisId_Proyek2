  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="<?=base_url();?>/lembaga/index">
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Lembaga Pelatihan</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item">Home</li>
              <li class="breadcrumb-item active" aria-current="page">Data Lembaga</li>
            </ol>
          </div>
          <div class="btn btn-lg active btn-custom">
            <a href="<?=base_url()?>/lembaga/edit_data">Edit Data Lembaga Pelatihan</a>
        </div>
